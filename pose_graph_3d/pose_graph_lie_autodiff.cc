...
#include "local_parameterization_se3_auto.h"
...
namespace mytest {
    ...
    void BuildOptimizationProblem(const VectorOfConstraints &constraints,
        ...
        ceres::LocalParameterization *local_parameterization = new ceres::AutoDiffLocalParameterization<LocalParamSE3Autodiff,7,6>();
        ...
        for (VectorOfConstraints::const_iterator constraints_iter = constraints.begin();
            ...
            PoseLieCostFunction *c = new PoseLieCostFunction(constraint.t_be.se3, sqrt_information);

            ceres::CostFunction *cost_function = new ceres::AutoDiffCostFunction<PoseLieCostFunction,6,7,7>(c);
            ...
            problem->SetParameterization(pose_begin_iter->second.se3.data(), local_parameterization);

            problem->SetParameterization(pose_end_iter->second.se3.data(), local_parameterization);
