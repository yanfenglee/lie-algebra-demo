...
#include "local_parameterization_se3_analytic.h"
...
namespace mytest {
    ...
    void BuildOptimizationProblem(const VectorOfConstraints &constraints,
        ...
        for (VectorOfConstraints::const_iterator constraints_iter = constraints.begin();
            ...
            problem->AddParameterBlock(pose_end_iter->second.se3.data(), 7, localparam);

            // Ceres will take ownership of the pointer.
            ceres::CostFunction *cost_function = new PoseLieAnalyticCostFunction(constraint.t_be.se3);
